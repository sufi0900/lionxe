...
import { ConsolidationBenefitsPanel } from "./ConsolidationBenefitsPanel";
import { InlineLink } from "@/components/report/InlineLink";
import { CartsVsMallDiagram } from "./CartsVsMallDiagram";
import { LocationArchitectureDiagram } from "./LocationArchitectureDiagram";
import { PillarClusterTreeDiagram  } from "./PillarClusterTreeDiagram";
import { WorkflowSteps } from "@/components/report/WorkflowSteps";
import { AquariumDiagram } from "./AquariumDiagram";
    ...
    <main className="report-shell">
     ...
     <MiniHeading>The Same Structure Inside the Company&apos;s Own Industry</MiniHeading>
      <Paragraph>
        ...
        as the pattern repeats at every scale of the industry.{" "}
        ...
        operates a separate website per city, allowing them to hold the positions
        the documented network has been unable to reach with 87 separate sites.
      </Paragraph>
