...
export default function Chapter6Page() {
  return (
    <main className="report-shell">
      ...
      <Paragraph>
        The{" "}
        <InlineLink href="https://docs.google.com/spreadsheets/d/1bAiLT2kMXpiIi3EbcOWDdmJM14nFruVwwo8sC75Hh5E/edit?pli=1&gid=0#gid=0">
          content sheet
        </InlineLink>{" "}
        ...
        pattern.
         ...
         <Screenshot
              src="/report-assets/chapter-6/Content-Sheet-Blogs-Services-Google-Sheets.png"
              alt="Content sheet for blog posts"
              caption="Content sheet used to manage blog production across documented sites"
            />
      <Paragraph>
