...
export default function Chapter4Page() {
  return (
    <main className="report-shell">
      ...
      <Paragraph>
        The company&apos;s site-inventory-spreadsheetoutput sits squarely within the volume-driven pattern
 ...
 <Screenshot
        src="/report-assets/chapter-4/KW-research-for-Blogs-aandb-carpet-cleaning.png"
      ...
      <Paragraph>
        ...
        <InlineLink href="https://docs.google.com/spreadsheets/d/1hSty0FOzKtDEBPNG0q8R9JIbSQEE48QIehx3e5XZQaQ/edit?gid=1528929624#gid=1528929624">
          keyword sheet
        </InlineLink>
      ...
      <KeywordIntentDiagram
        ...
        keywords={[
          ...
          { role: "secondary", keyword: "how to get stains out of a mattress" },
          { role: "secondary", keyword: "how to clean stains off mattress" },
          { role: "secondary", keyword: "how to remove stains from mattress" },
          { role: "secondary", keyword: "clean stain from mattress" },
          { role: "secondary", keyword: "how to get rid of stain on mattress" },
        ]}
      ...
      <DataTable
        ...
        rows={[
          ...
          { cells: ["Total keyword repetition", "", "", "~164"], isTotal: true },
          { cells: ["Share of 1,200-word post", "", "", "13.7%"], isTotal: true },
        ]}
        flagText="13.7%"
      />
      <Paragraph>
