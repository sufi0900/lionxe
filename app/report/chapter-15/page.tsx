...
import { PhaseRoadmapTimeline } from "./PhaseRoadmapTimeline";
  ...
  return (
    <main className="report-shell">
      ...
      <PhaseRoadmapTimeline
        figureNumber="15.1"
        title="The Six-Phase Transition Roadmap"
        phases={[
          {
      ...
      <DataTable
        ...
        rows={[
          ...
          },
          {
            cells: [
              "SEO",
              "Managing 720-row spreadsheet and sitemap rollout",
      ...
      <BulletList
        items={[
          "The transition follows six sequential phases: domain and infrastructure foundation, content architecture, content production, channel consolidation, and authority building.",
