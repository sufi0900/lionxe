...
import { ContrastCards } from "./ContrastCards";
...
// Remove: import { ContrastCards } from "@/components/report/ContrastCards";
// Remove: import { HorizontalFlowArrow } from "@/components/report/HorizontalFlowArrow";

// import { SurfaceSubstanceComparison } from "@/components/report/SurfaceSubstanceComparison";
...
<Screenshot
        src="/report-assets/chapter-5/Free-Keyword-Difficulty-Checker-Ahrefs.png"
        alt=""
        caption=""
      />
 ...
 <Screenshot
        src="/report-assets/chapter-5/New-AI-classifier-for-indicating-AI-written-text.png"
        alt=""
        caption=""
      />
...
/>
      ...
      <Paragraph>
        ...
        its surface characteristics.
             ...
             {/* // Example of how to update the Figure 5.3A call in page.tsx for the violation pipeline: */}
     <ProcessTimeline
        figureNumber="5.3A"
        title="The Current AI Pipeline: Detection Evasion Workflow"
        variant="warning"
        steps={[
          { label: "AI Draft", description: "Automated generation from keyword prompt" },
          { label: "Humanizer", description: "Rephrasing tool alters surface text" },
          { label: "Detection Check", description: "Testing against third-party AI scanners" },
          { label: "Rewrite", description: "Re-processing if score is too high" },
          { label: "Publish", description: "Content live with zero added value" },
        ]}
      />
      ...
      <Paragraph>
        ...
        informational core comes from the person, not the tool.
            ...
            <ProcessTimeline
                    figureNumber="5.3B"
                    title="The Proposed Architecture: Insight-Led AI Assistant Workflow"
                    variant="success"
                    steps={[
                      { label: "Research", description: "Writer gathers original data and insights" },
                      { label: "Structure", description: "Format and angle determined by subject" },
                      { label: "AI Draft", description: "AI assists using writer's research, not prompts" },
                      { label: "Review", description: "Editorial polish for accuracy and depth" },
                      { label: "Publish", description: "High-value content live on authority domain" },
                    ]}
                  />
