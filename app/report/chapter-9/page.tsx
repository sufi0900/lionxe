...
//
// Chapter 9: Video and Social Media Strategy.
// Originally numbered Chapter 8 before the insertion of the new Chapter 7.
  ...
  return (
    <main className="report-shell">
      ...
      <ContrastCards
        ...
        leftBody="Each account builds its own minimal follower base, engagement history, and algorithmic profile independently. No single account accumulates enough activity to earn platform recommendation. The company's 30-year reputation is invisible."
        rightLabel="CONSOLIDATED MODEL: ONE BRAND PER PLATFORM"
        rightBody="One Facebook page, one Instagram account, one YouTube channel. All engagement signals, follower growth, and content history concentrate into a single entity that builds platform authority through consistent, high-quality activity under one identity."
      />
