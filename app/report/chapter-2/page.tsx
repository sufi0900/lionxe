...
export default function Chapter2Page() {
  return (
    <main className="report-shell">
      ...
      {/* 2.9 */}
      <SectionHeading>2.9 Document Handling and Confidentiality</SectionHeading>
      <Paragraph>
        The integrity standards applied to the research extend to the handling
        of the document itself. This report exists in a single printed copy,
        produced on the author&apos;s personal printer, so that its contents
        have passed through no third-party device, service, or print facility.
      </Paragraph>
      <Paragraph>
        The report has not been shared with any member of staff or any external
        party, and no person other than the author and the recipient is aware
        of its existence or its contents. The research it contains was
        conducted solely by the author. This handling standard follows the same
        integrity principle the report itself applies as an evaluation
        standard, and it remains in force after delivery.
      </Paragraph>
