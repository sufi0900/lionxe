...
A complete look at how strategist Sufian Mustafa engineered the LIONXE™ framework and uses its strict standards to build high-authority, real-world digital projects like Do It With AI Tools.          </p>
        </motion.div>
        ...
        <div className="hidden lg:block">
          <div className="relative mx-auto max-w-6xl py-6">
            ...
            {/* Connection SVG Layers — Placed on z-20 to sit beautifully on top of card boundaries */}
            <svg
            ...
            >
              <defs>
                ...
                <linearGradient id="lineVerticalFramework" x1="0%" y1="0%" x2="0%" y2="100%">
                  <stop offset="0%" stopColor="#004DFD" stopOpacity="1" />
                  <stop offset="100%" stopColor="#0891B2" stopOpacity="1" />
                </linearGradient>

                {/* Ultra-Sharp Arrowhead Markers */}
                <marker
                  id="arrowToLionxe"
                  markerWidth="10"
                  markerHeight="10"
                ...
                {/* Crisp Entering Arrowhead for DoItWithAI Card */}
                <marker
                  id="arrowFlowDown"
                  markerWidth="12"
                  markerHeight="12"
              ...
              {/* 3. LIONXE ➔ Do It With AI Tools (Highly visible vertical motion down left flank) */}
...
/>
            ...
            {/* Proportional Grid Layer Layout (z-10) */}
          {/* Proportional Grid Layer Layout (z-10) */}
...
>
  ...
  >
    ...
    {/* Manual down arrowhead — always points downward */}
    <path
